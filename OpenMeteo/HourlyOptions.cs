...
namespace OpenMeteo
{
    ...
    {
        public static HourlyOptions All => new HourlyOptions((HourlyOptionsParameter[])Enum.GetValues(typeof(HourlyOptionsParameter)));

        /// <summary>
        /// A copy of the current applied parameter. This is a COPY. Editing anything inside this copy won't be applied 
        /// </summary>
        public List<HourlyOptionsParameter> Parameter => new List<HourlyOptionsParameter>(_parameter);
        ...
        private HourlyOptions(HourlyOptionsParameter[] parameter)
        {
        ...
        private void Add(HourlyOptionsParameter[] param)
        {
